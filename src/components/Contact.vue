  ...
  switch (field) {
    ...
    case 'message':
      if (form.value.message.length < 20) {
        errors.value.message = 'Le message doit contenir au moins 20 caractères'
      } else {
  ...
  <div class="container">
    <transition name="fade" mode="out-in">
      ...
      <div v-if="isSubmitted" class="success-message">
        ...
        <p>Merci de nous avoir contactés. Nous avons bien reçu votre demande et le fichier a été téléchargé.</p>
